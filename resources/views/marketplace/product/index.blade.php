        ...
        <div class="align-center container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                    <h1 class="mbr-section-title mbr-fonts-style mbr-white mb-3 display-1"><strong>Jual Produk Khas Bumdes Mina Harapan</strong></h1>
                </div>
            </div>
            @auth
                <div class="mbr-fonts-style align-center mb-0 mt-2"><a href="{{ route('marketplace.dashboard') }}" class="btn item-btn btn-primary display-7" >Dashboard &gt;</a></div>
            @endauth
        </div>
    </section>
                    ...
                    <div class="item features-image сol-12 col-md-6 col-lg-4" style="cursor: default">
                        <div class="item-wrapper">
                            ...
                            <div class="item-content">
                                <h6 class="item-subtitle mbr-fonts-style mt-1 display-7"><strong>{{ $index->name }}</strong></h6>
                                {{-- <h5>Rp {{ number_format($row->price) }}</h5> --}}
                                <span class="cost mbr-fonts-style display-7">
                                    Rp {{number_format($index->price)}}
                                    &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; {{number_format($index->weight)}} kg
                                </span>
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">
                                    {!!$index->description!!}
                                </p>
                            </div>
                            <div class="mbr-section-btn item-footer mt-2"><a href="{{route('marketplace.show_product', ['slug' => $index->slug])}}" class="btn item-btn btn-primary display-7">Lihat Detail Produk &gt;</a></div>
                        </div>
                    </div>
                @endforeach
            </div>
