                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="width: 20%;">
                                                <img src="{{ $row->image }}" width="100%" height="auto" alt="{{ $row->name }}">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <form method="post" action="{{ route('product.destroy', ['product' => $row->id]) }}">
                                                    @method('DELETE')
                                                    @csrf
                                                    <a href="{{ route('product.edit', ['product' => $row->id]) }}" class="btn btn-warning btn-sm">Edit</a>
