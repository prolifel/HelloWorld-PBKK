...
<head>
    ...
    <title>BUMDes Mina Harapan - Potensi Pariwisata</title>
...
<body>
    ...
    <section class="content4 cid-svRmpGkj6e" id="content4-18">
        <div class="container">
            <div class="row justify-content-center">
                <div class="title col-md-12 col-lg-10">
                    <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2"><strong>Pariwisata BUMDes Mina Harapan</strong></h3>
    ...
    <section class="image3 cid-svRmpHtPhZ" id="image3-19">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-5">
                    <div class="image-wrapper">
                        <img src="{{ asset('assets/images/pariwisata-467x281.jpg') }}" alt="imgPariwisata">
                        <p class="mbr-description mbr-fonts-style mt-2 align-center display-4">
                            Pariwisata BUMDes Mina Harapan</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="content5 cid-svRmpIjSE6" id="content5-1a">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">

                    <h4 class="mbr-section-subtitle mbr-fonts-style mb-4 display-1">Pariwisata Desa Bendiljati Wetan</h4>
                    <p class="mbr-text mbr-fonts-style display-7">
                        Di kawasan desa Bendiljati Wetan sendiri telah berdiri angkringan yang berlokasi di pinggir kolam ikan Bumdes Mina Harapan, Angkringan yang diberi nama Angkringan Nol Km Bumdes ini buka mulai dari jam 4 sore hingga pukul 12 Malam, Angkringan ini menjual berbagai macam olahan hidangan seperti sate-satean, gorengan, dan untuk minumannya sendiri terdapat aneka kopi dan teh. </p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section style="background-color: #fff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif; color:#aaa; font-size:12px; padding: 0; align-items: center; display: flex;"><a href="https://mobirise.site/x" style="flex: 1 1; padding-left: 1rem;"></a>
        <p style="flex: 0 0 auto; margin:0; padding-right:1rem;"><a href="https://mobirise.site/q" style="color:#aaa;">The web page</a> was built with Mobirise templates</p>
    </section>
