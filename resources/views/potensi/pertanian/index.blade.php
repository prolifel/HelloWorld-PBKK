...
<body>
    <section class="menu menu3 cid-svRmuvjpRT" once="menu" id="menu3-1j">
    ...
    <section class="content4 cid-svRmuwtdoO" id="content4-1k">
        <div class="container">
            <div class="row justify-content-center">
                <div class="title col-md-12 col-lg-10">
                    <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2"><strong>Pertanian BUMDes Mina Harapan</strong></h3>
    ...
    <section class="image3 cid-svRmuxfAP4" id="image3-1l">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-5">
                    <div class="image-wrapper">
                        <img src="{{ asset('assets/images/pertanian-366x314.jpg') }}" alt="imgPertanian">
    ...
    <section class="image3 cid-sw9x4oYaSq" id="image3-1q">

        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-5">
                    <div class="image-wrapper">
                        <img src="{{ asset('assets/images/pertanian1-366x278.jpg') }}" alt="imgPertanian">
                        <p class="mbr-description mbr-fonts-style mt-2 align-center display-4">
                            Pertanian BUMDes Mina Harapan</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="content5 cid-svRmuxXHfG" id="content5-1m">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">

                    <h4 class="mbr-section-subtitle mbr-fonts-style mb-4 display-1">
                        Pertanian Padi dan Tebu</h4>
                    <p class="mbr-text mbr-fonts-style display-7">
                        Pertanian yang dikelola oleh Bumdes Mina Harapan meliputi pertanian padi dan pertanian tebu dengan luas wilayah sekitar 2 Hektar, dengan masa panen untuk padi sekitar 3 bulan sekali dan untuk tebu sekitar 6 bulan sekali.</p>
                </div>
            </div>
        </div>
    </section>

    <section class="footer6 cid-svRmuz88x1" once="footers" id="footer6-1o">
        <div class="container">
    ...
    <section style="background-color: #fff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif; color:#aaa; font-size:12px; padding: 0; align-items: center; display: flex;"><a href="https://mobirise.site/i" style="flex: 1 1; height: 3rem; padding-left: 1rem;"></a>
        <p style="flex: 0 0 auto; margin:0; padding-right:1rem;"><a href="https://mobirise.site/q" style="color:#aaa;">This site</a> was built with Mobirise website templates</p>
    </section>
