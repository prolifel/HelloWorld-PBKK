...
<head>
    ...
    <title>BUMDes Mina Harapan - Membuat Artikel</title>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8 mx-auto mbr-form">
                    <form action="{{ route('article.store') }}" method="POST" enctype="multipart/form-data" class="mbr-form form-with-styler">
                        @csrf
                        <div class="dragArea row">
                            <div class="col-md col-sm-12 form-group" data-for="name">
                                <label for="title">Judul</label>
                                <input type="text" name="title" data-form-field="title" class="form-control" value="" id="title" required>
                            </div>
                            <div class="col-md col-sm-12 form-group" data-for="email">
                                <label for="subtitle">Subjudul</label>
                                <input type="text" name="subtitle" data-form-field="email" class="form-control" value="" id="subtitle" required>
                            </div>
                            <div class="col-12 form-group" data-for="image">
                                <label for="image">Foto Utama</label>
                                <input type="file" name="image" class="form-control" value="" id="image" required>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 align-center mbr-section-btn"><button type="submit" class="btn btn-primary display-4">Buat Artikel</button></div>
                        </div>
                    </form>
                </div>
            </div>
