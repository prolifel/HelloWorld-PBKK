		...
		<div class="banner_inner d-flex align-items-center">
			<div class="container">
				<div class="banner_content text-center">
					...
					<div class="page_link">
                        <a href="{{ url('/') }}">Home</a>
                        <a href="{{ route('marketplace.list_cart') }}">Cart</a>
					</div>
				</div>
			</div>
		</div>
							...
							<tr class="out_button_area">
								...
								<td>
									<div class="checkout_btn_inner">
										<a class="gray_btn" href="{{ route('marketplace.product') }}">Continue Shopping</a>
										<a class="main_btn" href="{{ route('marketplace.checkout') }}">Proceed to checkout</a>
									</div>
								</td>
							</tr>
						</tbody>
